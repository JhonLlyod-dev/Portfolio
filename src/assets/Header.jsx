  ...
  return(
    <div className="motion-preset-fade-sm flex fixed top-0 z-5 justify-between w-full items-center px-4 md:px-8 py-3  bg-[#101010]/30 border-b-[1px] border-purple-400 rounded-b-xl backdrop-blur-xs">
      <div className="flex-1 flex justify-start items-center ">
        <h1 className="motion-preset-slide-down-lg font-bold md:text-xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"><a href="#Home">Zhenmar</a></h1>
      </div>
      ...
      <div className="flex flex-1 gap-5 justify-end items-center">
        <a  href="https://docs.google.com/document/d/1qj_91il-x5rQPbEx0E1lnTbhHYuVW4XiXCmYbF4wLZs/edit?tab=t.0#heading=h.d9dbogz6wawj" target="_blank" className=" motion-preset-slide-down-lg motion-delay-600 font-semibold btn-anim text-sm md:text-base flex items-center gap-2 py-2 px-4 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 "><Download size={16} strokeWidth={2.25} /> Resume</a>
