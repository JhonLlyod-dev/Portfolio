...
export default function Body(){
  ...
  return(
    <div className='motion-preset-fade-lg flex flex-col items-center py-2 '>
      <section id='Home' className='flex items-center justify-between pt-30 pb-15  flex-col min-h-[85vh] md:min-h-screen '>
        <div className='flex-center flex-col gap-1 text-white'>
          ...
          <h1 className='motion-preset-slide-up-md motion-delay-100 font-bold text-4xl md:text-6xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent py-3 '>Jhon Llyod Navarro</h1>
          <h2 className='text-xl md:text-2xl pb-1 motion-preset-slide-up-md motion-delay-200'>Full Stack Developer & UI/UX Designer</h2>
          <p className=' w-full text-sm px-2 md:w-[60%] md:text-lg motion-preset-slide-up-md motion-delay-300'>I build responsive, functional web applications that address real-world problems. Backed by over a year of experience with modern web technologies and development best practices.</p>
          <div className='flex-center w-full gap-4 py-4 font-semibold mt-5'>
            <a href='#Contact' className='btn-anim motion-preset-slide-right-md cursor-pointer bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex-center gap-2 py-2 px-4'><Mail size={18} strokeWidth={1.50}/>Get in Touch</a>
            <a href='https://github.com/JhonLlyod-dev' target='_blank' className='btn-anim motion-preset-slide-left-md cursor-pointer  border-1 border-pink-600 text-pink-600 hover:bg-pink-600 hover:text-white    rounded-lg flex-center gap-2 py-2 px-4'><Github size={18} strokeWidth={1.50}/>Github</a>
          </div>
        </div>

        <Mouse className=' motion-translate-y-loop-25 motion-ease-spring-smooth' size={30} strokeWidth={1.50} />
