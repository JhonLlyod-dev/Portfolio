    ...
    <div className='motion-preset-fade-lg flex flex-col items-center py-2 '>
      <div className='flex items-center justify-between pt-30 pb-15 md:pb-25 flex-col min-h-[85vh] md:min-h-screen '>
        <div className='flex-center flex-col gap-1 text-white'>
          ...
          <p className=' w-full text-sm px-2 md:w-[60%] md:text-lg motion-preset-slide-up-md motion-delay-300'>Passionate about creating beautiful, functional web applications that solve real-world problems. 5+ years of experience in modern web technologies.</p>
      ...
      <div className='intersect-once intersect:motion-preset-slide-up motion-delay-100 text-gray-400 text-justify flex-center  flex-col md:flex-row gap-10 pb-10 px-6 md:px-10 lg:px-34 xl:px-44'>
