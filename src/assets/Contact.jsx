...
export default function Contact(){
  return(
    <section id="Contact" className="intersect-once intersect:motion-preset-fade motion-delay-200 mt-10 w-full text-gray-400 text-justify bg-gradient-fade flex flex-col  items-center gap-6 px-6 py-5 pb-10 md:px-10 lg:px-24 xl:px-44">
      ...
      <div className="flex-center flex-col lg:flex-row lg:items-start gap-10">
        <div className="flex-center lg:items-start gap-4 flex-col ">
          ...
          <button className="intersect-once intersect:motion-preset-fade motion-delay-100 btn-anim w-fit py-2 px-4 flex-center gap-2 font-semibold bg-gradient text-white rounded-lg"><Mail size={18} strokeWidth={1.50}/>navarro.jhonllyod2005@gmail.com</button>
          <div className="flex-center flex-wrap lg:flex-nowrap lg:flex-col lg:items-start gap-4">
            <a href="https://www.facebook.com/Rhaia.llyod/" target="_blank" className="intersect-once intersect:motion-preset-fade motion-delay-200 btn-anim transition w-fit py-2 px-4 flex-center gap-2 font-semibold rounded-lg text-blue-600 border-1 border-blue-600 hover:bg-blue-600 hover:text-white"><Facebook size={18} strokeWidth={1.50}/>Facebook</a>
            <a href="https://www.linkedin.com/in/jhon-llyod-navarro-15635b373/" target="_blank" className="intersect-once intersect:motion-preset-fade motion-delay-300 btn-anim transition w-fit py-2 px-4 flex-center gap-2 font-semibold rounded-lg text-purple-600 border-1 border-purple-600 hover:bg-purple-600 hover:text-white"><Linkedin size={18} strokeWidth={1.50}/>LinkedIn</a>
            <a href="https://github.com/JhonLlyod-dev" target="_blank" className="intersect-once intersect:motion-preset-fade motion-delay-400 btn-anim transition w-fit py-2 px-4 flex-center gap-2 font-semibold rounded-lg text-pink-600 border-1 border-pink-600 hover:bg-pink-600 hover:text-white"><Github size={18} strokeWidth={1.50}/>GitHub</a>
          </div>
        </div>
